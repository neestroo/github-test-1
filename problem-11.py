...
for character in rhyme:
    if character.isalpha():
        if character in character_Counts:
            ...
            character_Counts[character] = 1
most_Common_Characters = max(character_Counts, key=character_Counts.get)
frequency = character_Counts[most_Common_Characters]
print(
    f"Most common characters are '{most_Common_Characters}' with {frequency} occurrences"
)
...
# filtered=[character for character in rhyme.lower() if character.isalpha()]

# character_Count=Counter(filtered)

# most_Common_Character=character_Count.most_common(1)[0]
# print(f"Most character is '{most_Common_Character[0]}' with {most_Common_Character[1]} appears")
